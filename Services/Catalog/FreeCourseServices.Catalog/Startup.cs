...
namespace FreeCourseServices.Catalog
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // configuration transactionlarýný bir class üzerinden okuma optionsPattern denir.
            services.AddAutoMapper(typeof(Startup));
            services.AddControllers();

            services.Configure<DatabaseSettings>(Configuration.GetSection("DatabaseSettings"));

            /// IOptions üzerinden DatabaseSettings ulaþmamak için 
            services.AddSingleton<IDatabaseSettings>(sp =>
            {
                // GetRequiredService GetServiceden farklý ilgili service bulamazsa hata fýrlatýr. 
                /// Mutlaka olmasý gerekir.
